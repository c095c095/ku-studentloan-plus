                ...
                <div class="space-y-6">
                  <div class="space-y-6">
                    <div class="space-y-2">
                      ...
                      <input type="text" id="student-id" required pattern="\d{1,10}" maxlength="10" placeholder="รหัสนิสิต" class="w-full h-9 px-3 py-1 text-base border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500">
                    </div>
                    <div class="space-y-2">
                      <label for="idc" class="text-sm font-medium">เลขประจำตัวประชาชน</label>
                      <div class="relative">
                        <input type="password" id="idc" required pattern="\d{1,13}" maxlength="13" placeholder="เลขประจำตัวประชาชน" class="w-full h-9 px-3 py-1 text-base border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <button type="button" id="login-button" class="w-full h-9 px-4 py-2 inline-flex items-center justify-center text-sm font-medium rounded-md bg-green-600 text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 shadow">
                      เข้าสู่ระบบ
                    </button>
